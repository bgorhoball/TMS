  ...
  <div class="home">
    <div class="vue-template" v-if="login">
      ...
      <form>
        ...
        <button @click.prevent="loginUser" type="submit" class="btn btn-dark btn-lg btn-block">Sign In</button>
    ...
    <div class="vue-template" v-else>
      <form>
        ...
        <button @click.prevent="registerUser" type="submit" class="btn btn-dark btn-lg btn-block">Sign Up
        </button>
